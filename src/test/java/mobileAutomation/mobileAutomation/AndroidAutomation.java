...
//		System.setProperty("webdriver.chrome.driver", "/Users/sapnamishra/Documents/WebDriver/chromedriver");
	...
	@Test(priority = 1, description = "Test case 1: open mobile app and enter input data")
	public void mobile() {
	...
	@Test(priority = 2, description = "Test case 2: User registration")
	public void registraion() {
		...
		Select s = new Select(
				driver.findElement(By.xpath("//android.widget.CheckedTextView[@id = 'android:id/text1']")));
